...
export function SignInDialog({ children }: SignInDialogProps) {
  ...
  // Reset view when dialog closes (implicitly handled if component unmounts, but good to keep in mind)
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-3 pt-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm font-medium opacity-90">Over 700 categories</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 mt-0.5 opacity-90" />
                    <span className="text-sm font-medium opacity-90">Quality work done faster</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="h-5 w-5 mt-0.5 opacity-90" />
                    <span className="text-sm font-medium opacity-90">Access to talent and businesses across the globe</span>
                  </li>
                </ul>
              </div>
            </div>
